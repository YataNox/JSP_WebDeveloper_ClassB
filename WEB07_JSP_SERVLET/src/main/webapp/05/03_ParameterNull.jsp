...
<html>
	...
	<body>
		...
		== equals() 사용 결과 : error - equals 메소드는 "null"값으로 비교할 때 오류를 발생시킴<br>
		...
		<pre>
		<!-- <pre>태그 : 입력한 그대로를 화면에 보여주라는 태그 : 주로 코딩 내역을 화면에 표시할 때
		사용. 주로 코딩 내용을 웹페이지에 표시할 때 사용합니다. -->
