...
<html>
	...
	<body>
		<!-- 쿠키는 웹사이트 접속시 접속자의 개인 장치에 다운로드되고 브라우저에 저장되는 텍스트 파일입니다.
		웹사이트는 쿠키를 통해 접속자의 장치를 인식하고, 접속자의 설정과 과거 이용내역에 대한 일부 데이터를
		저장합니다.
		쿠키에는 만료일이 있습니다. 브라우저를 닫는 경우 자동으로 삭제되는 쿠키가 있을 수 있으며, 일부는
		수동으로 삭제되기전까지 남아있는 쿠키가 있습니다. -->
		
		<!-- 쿠키의 사용
		- 필수쿠키 : 페이지 탐색 웹사이트의 보안 영역 접속 그리고 검색을 포함한 웹사이트의 기본 기능을
		활성화할 목적으로 사용합니다.
		- 기능쿠키 : 웹사이트가 접속자의 지역 및 언어 등 웹사이트의 행태 및 외관에 영향을 줄 수 있는 접속자
